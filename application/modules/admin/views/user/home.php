...
<section class="content-header">
	<h1 id="title_header">
		<?php if(isset($title)){echo $title;}else{echo "ADMIN";} ?><!-- <small>Optional description</small> -->
	</h1>
	<ol class="breadcrumb">
	...
	<section class="content">
		...
		<div class="box box-info">
	        <div class="box-header">
	        	...
	        	<button class="btn btn-info pull-right" id="new_admin"><i class="fa fa-plus"></i> Create New Admin</button>
	        </div><!-- /.box-header -->
	        <div class="box-body">
	            	...
	            	<tbody>
	            		<?php foreach ($list->result() as $row) { ?>
			            	<tr>
				                ...
				                <td>
				                	<button class="btn btn-xs btn-warning btn-flat edit_admin" val-id="<?php echo $row->user_id; ?>"><i class="fa fa-edit"></i></button>
				                	<a href="<?php echo site_url('admin/user/delete').'/'.$row->user_id; ?>" class="delete_admin" val-name="<?php echo $row->user_name; ?>">
