...
class Member extends MX_Controller {
    ...
    {
        $cek = $this->m_user->getdata(array("user_email"=>$this->input->post("email")));
        ...
        if($cek->num_rows() < 1)
        {
            ...
            $this->m_user->insert($data_insert);
    ...
    {
        $data["data"] = $this->m_user->getdata(array("user_id"=>$id));
    ...
    public function post_edit()
    {
        ...
        $this->m_user->update($data_updated, array("user_id"=>$this->input->post("id_user")));
        $data_updated = array();
